...
typedef struct {
  ...
  real_T Delay1_DSTATE_px;
  real_T Delay_DSTATE_ch;
  ...
  rtDW_Chart_AutopilotLaws_k_T sf_Chart_c;
  rtDW_Chart_AutopilotLaws_T sf_Chart_n;
  rtDW_Chart_AutopilotLaws_T sf_Chart_jd;
  rtDW_Chart_AutopilotLaws_T sf_Chart_h;
  rtDW_Chart_AutopilotLaws_T sf_Chart_e;
  rtDW_Chart_AutopilotLaws_k_T sf_Chart_j;
...
struct Parameters_AutopilotLaws_T_ {
  ...
  real_T ScheduledGain_BreakpointsForDimension1_ad[6];
  real_T ScheduledGain_BreakpointsForDimension1_e[5];
  real_T ScheduledGain_BreakpointsForDimension1_pm[6];
  ...
  real_T Constant3_Value_ds;
  real_T Gain1_Gain_nb;
  ...
  real_T Saturation_UpperSat_ms;
  real_T Saturation_LowerSat_dp;
  real_T Gain_Gain_bl;
  ...
  real_T Gain1_Gain_i;
  real_T Delay_InitialCondition_gl;
  real_T Constant_Value_lo;
  real_T Delay1_InitialCondition_a;
  real_T Saturation_UpperSat_g;
  real_T Saturation_LowerSat_df;
...
class AutopilotLawsModelClass {
 ...
 private:
  ...
  void AutopilotLaws_Chart_f_Init(rtDW_Chart_AutopilotLaws_k_T *localDW);
  void AutopilotLaws_Chart_j(real_T rtu_right, real_T rtu_left, boolean_T rtu_use_short_path, real_T *rty_out,
    rtDW_Chart_AutopilotLaws_k_T *localDW);
